...
public class BankService {
	...
	public List<Branches> getBranchesDetails(@QueryParam("bank_name") String bank_name,
			@QueryParam("city_name") String city_name, @QueryParam("limit") String limit,
	...
	@Path("/Banks")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Bank> getBanksDetails(@QueryParam("ifsc") String ifsc, @QueryParam("limit") String limit,
			@QueryParam("offset") String offset) {
